...
public class AccountOperationsImpl  implements AccountOperation{
    ...
    @Override
    public double viewAccountBalance(String accountNumber, String user_id) {
        return 0;
    }
    ...
    public double creditAmount(String user_id, Connection connection) {
        ...
        if(authMap.containsKey(true))
        {
            ...
            try
            {
                PreparedStatement preparedStatement=connection.prepareStatement("select balance form accountdetails where accountnumber= ? ");
    ...
    @Override
    public double debitAmount(String accountNumber, String user_id) {
        return 0;
    }

    @Override
    public double viewBalance(String accountNumber, String user_id) {
        return 0;
    }
}
